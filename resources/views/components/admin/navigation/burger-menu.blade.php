<div>
    ...
    <label class="nav__toggle" aria-label="{{ __('header.open_main_menu') }}" for="menu-toggle">
    ...
    <x-admin.navigation.links nav_class="admin_nav_container" li_class="admin_burger_link"/>
</div>
