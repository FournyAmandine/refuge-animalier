@php
    $titles_col = [
        ...
        ['label' => __('volunteer_index.last_name'), 'tri' => 'true'],
        ['label' => __('volunteer_index.first_name'), 'tri' => 'true'],
        ['label' => __('volunteer_index.email'), 'tri' => 'true'],
        ['label' => __('volunteer_index.joined_at'), 'tri' => 'true'],
