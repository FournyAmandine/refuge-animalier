...
<tr class="hover:bg-orange-200/20 border-b border-orange-200/70">
    @if(\Illuminate\Support\Str::startsWith($src, 'assets/img/'))
        <td class="text-center p-4"><a title="Aller vers la page de {!! $first_name !!}" href="{!! route('admin.volunteers.show', $id) !!}"><img class="inline-block rounded-xl hover:scale-110 transition-all duration-250 w-[100px] h-[66px] object-cover object-[50%_30%]" width="100" src="{!! $src_db !!}" alt="Image de votre bénévole {!! $first_name !!}"></a></td>
    @else
        <td class="text-center p-4"><a title="Aller vers la page de {!! $first_name !!}" href="{!! route('admin.volunteers.show', $id) !!}"><img class="inline-block rounded-xl hover:scale-110 transition-all duration-250 w-[100px] h-[66px] object-cover object-[50%_30%]" width="100" src="{!! $src_storage !!}" alt="Image de votre bénévole {!! $first_name !!}"></a></td>
    @endif
