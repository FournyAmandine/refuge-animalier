...
<article class="bg-orange-50 border-2 border-orange-600 w-[340px] lg:w-[400px] rounded-xl relative shadow-[var(--shadow-xl)] hover:scale-105 transition duration-300">
