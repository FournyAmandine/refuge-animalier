...
<article class="bg-orange-50 border-2 border-orange-600 w-[340px] rounded-xl relative shadow-[var(--shadow-xl)]">
    ...
    @endif    <div>
        ...
        <div class="flex gap-4 absolute right-2 top-85">
            <x-admin.button_action title="Voir le profil" href="{!! route('admin.volunteers.show', $id) !!}" :src="asset('assets/img/icones/eye.svg')" alt="Icone d'un oeil pour voir la fiche" />
