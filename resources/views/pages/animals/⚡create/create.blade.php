    ...
    <section>
        ...
        <form method="post" class="xl:max-w-10/12 m-auto" wire:submit="save">
            @csrf
                <x-admin.form.fields.fieldset>
                    ...
                    <div class="sm:flex sm:flex-wrap gap-6">
                        <x-admin.form.fields.input field_name="animal_name" label="Entrez son nom" :required="true" placeholder="Charly"/>
                        <x-admin.form.fields.inputs_radio/>
                        <x-public.form.fields.select field_name="animal_statut" :required="true" label="Sélectionnez le statut">
                    ...
                    <div class="sm:flex sm:flex-wrap gap-6">
                        <x-public.form.fields.select field_name="animal_type" :required="true" label="Sélectionnez le type">
                            <x-public.form.fields.option selected="selected" value="none" option_name="--Votre choix--"/>
                            <x-public.form.fields.option value="dog" option_name="Chien"/>
                            <x-public.form.fields.option value="rabbit" option_name="Lapin"/>
                            <x-public.form.fields.option value="cat" option_name="Chat"/>
                        </x-public.form.fields.select>
                        <x-public.form.fields.select field_name="animal_race" label="Sélectionnez la race" disabled="disabled">
                            <x-public.form.fields.option selected="selected" value="none" option_name="--Votre choix--"/>
                            <x-public.form.fields.option value="staff" option_name="American Staff"/>
                            <x-public.form.fields.option value="golden" option_name="Golden Retriever"/>
            ...
            <x-admin.form.fields.fieldset>
                ...
                <div class="sm:flex sm:flex-wrap gap-6">
                    <x-admin.form.fields.input field_name="animal_pictures" :required="true" accept="image/png, image/jpeg" label="Choisissez une/des image(s)" type="file"/>
                    <x-admin.form.fields.input field_name="animal_coat" label="Entrez son pelage" :required="true" placeholder="Poils longs, blancs et noirs..."/>
                </div>
                <x-admin.form.fields.textarea field_name="animal_description" label="Entrez une brève description" placeholder="Ce chien est un peu fou mais très amical..."/>
            </x-admin.form.fields.fieldset>
