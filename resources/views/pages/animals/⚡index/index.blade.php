...
<main class="lg:flex-1 bg-orange-50/30">
    ...
    <x-admin.sections.filter href="{!! route('admin.animals.create') !!}"
                             title_button="Aller vers la page pour ajouter un animal" label="Ajouter un animal"
                             title_page="Page d'index des animaux"/>
