    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md dark:text-gray-600 dark:bg-orange-700 dark:border-gray-600">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    {{-- Next Page Link --}}
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-orange-50 bg-orange-600 border-orange-700 leading-5 rounded-md hover:text-lg focus:outline-none focus:ring ring-gray-300 focus:border-b-orange-700 active:bg-orange-600 active:text-orange-50 transition ease-in-out duration-150 dark:bg-orange-600 dark:border-b-orange-800 dark:text-orange-50 dark:focus:border-orange-700 dark:active:bg-orange-600 dark:active:text-orange-50 aria-label="{{ __('pagination.next') }}">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
