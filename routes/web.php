...
Route::livewire('/admin/profil', 'pages::profil')->name('profil')->middleware('auth');
...
Route::livewire('/admin/volunteers/create', 'pages::volunteers.create')->name('admin.volunteers.create')->middleware('auth');
Route::livewire('/admin/volunteers/{volunteer}/edit', 'pages::volunteers.edit')->name('admin.volunteers.edit')->middleware('auth');
Route::livewire('/admin/volunteers/{volunteer}', 'pages::volunteers.show')->name('admin.volunteers.show')->middleware('auth');
Route::livewire('/admin/volunteers', 'pages::volunteers.index')->name('admin.volunteers.index')->middleware('auth');

Route::livewire('/admin/messages', 'pages::messages.index')->name('admin.messages.index')->middleware('auth');

Route::livewire('/admin/adoptions', 'pages::adoptions.index')->name('admin.adoptions.index')->middleware('auth');

Route::livewire('/admin/tasks', 'pages::tasks.index')->name('admin.tasks.index')->middleware('auth');
